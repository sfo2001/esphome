...
from esphome import linux_deploy
...
def command_prepare_linux(args: ArgsProtocol, config: ConfigType) -> int | None:
    """Generate Linux deployment package - wrapper for linux_deploy module."""
    return linux_deploy.command_prepare_linux(args, config)
